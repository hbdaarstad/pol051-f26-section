...
Most of the data in this course will come from packages. But most of the data in the world is not in a package. How can I read this kind of data into R?

There’s ways to do this in RStudio through [drop-down menus](https://support.posit.co/hc/en-us/articles/218611977-Importing-Data-with-the-RStudio-IDE) but I call that the “no learning” approach.
...
How to find it? Operating systems are always changing so in general the best thing is to google how to find a file’s filepath and then remember it. But the following seems to have worked on Mac for a long time now:

1.  find the file in your Finder right-click and select “get info”

2.  at the top left, under “General”, you’ll see the file path next to “Where:”

3.  right-click that path and select “copy as Pathname”
